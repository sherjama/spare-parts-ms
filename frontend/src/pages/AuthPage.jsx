    ...
    <div className="w-[60vw] mx-auto p-6 bg-white rounded-xl shadow-lg flex flex-col items-center justify-center">
      ...
      <div className="flex w-full justify-evenly items-center flex-wrap">
        ...
        <div className="mt-6 text-center ">
          <div className="h-44 border w-0 "></div>
        ...
        <div className=" w-1/2">
          <div className="flex justify-center gap-4 mt-6 flex-col  items-center">
            <button className="flex items-center  gap-2  bg-blue-500 text-white w-7/12 ">
            ...
            <button className="flex items-center  gap-2 bg-blue-900  text-white w-7/12 ">
              <span className="bg-white  ml-[2px] py-3 px-3">
      ...
      <div className="font-nexar1 text-[12px] leading-4 text-gray-500">
        <p>
          * By signing up, you agree to our <a href="3">Terms of Use</a> and
